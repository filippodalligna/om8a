...
def create_block_db(app):
    ...
    def _create_block_db(name, difficulty, uploader_id=1, status='active'): # Added status parameter
        ...
        with app.app_context():
            ...
            block = ClimbingBlock(name=name, difficulty=difficulty, uploader_id=uploader_id, status=status)
